      ...
      <div className="flex justify-between items-center bg-gray-900 dark:bg-gray-800 text-white px-4 py-2">
        ...
        <div className="flex items-center gap-3 md:hidden">
          ...
          >
            ...
            <span className="absolute -top-2 -right-2 bg-yellow-400 text-black text-xs font-bold min-w-[16px] h-[16px] px-[5px] flex items-center justify-center rounded-full border border-white shadow-sm">
        ...
        <div className="hidden md:flex items-center space-x-6 text-sm font-medium">
          ...
          >
            ...
            <span className="absolute -top-2 -right-3 bg-yellow-400 text-black text-[10px] font-bold min-w-[20px] h-[20px] px-1 flex items-center justify-center rounded-full border border-white shadow-md">
              {cartCount > 99 ? '99+' : cartCount ?? 0}
            </span>
          </div>
