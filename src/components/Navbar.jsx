...
const Navbar = () => {
  ...
  return (
    <header className="shadow-md sticky top-0 z-50 bg-white dark:bg-gray-900">
      <div className="flex items-center bg-gray-900 dark:bg-gray-800 text-white px-4 py-2 space-x-4">
        ...
        <form
          onSubmit={onSearch}
          className="flex flex-1 mx-4 bg-white dark:bg-gray-700 rounded overflow-hidden"
        >
          <input
            type="text"
